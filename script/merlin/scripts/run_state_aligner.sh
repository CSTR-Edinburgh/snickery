#!/bin/bash
## Project: SCRIPT
## From: https://github.com/CSTR-Edinburgh/merlin/tree/master/egs/build_your_own_voice/s1/scripts/run_state_aligner.sh
...
sed -i s#'work_dir =.*'#'work_dir = "'$lab_dir'"'# $aligner/forced_alignment.py
sed -i s#'wav_dir =.*'#'wav_dir = "'$wav_dir'"'# $aligner/forced_alignment.py
