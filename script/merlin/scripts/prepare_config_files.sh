...
## Based on: https://github.com/CSTR-Edinburgh/merlin/tree/master/egs/build_your_own_voice/s1/scripts/prepare_config_files.sh
...
duration_config_file=${WorkDir}/conf/duration_${Voice}.conf
...
acoustic_config_file=${WorkDir}/conf/acoustic_${Voice}.conf
