...
## Based on: https://github.com/CSTR-Edinburgh/merlin/tree/master/egs/build_your_own_voice/s1/scripts/prepare_config_files_for_synthesis.sh
...
duration_config_file=${WorkDir}/conf/test_dur_synth_${Voice}.conf
...
acoustic_config_file=${WorkDir}/conf/test_synth_${Voice}.conf
